...
export default class Tutorial extends Component {
	...
	componentDidMount() {
		...
		this.steps = [
			...
			<Dummy manager={manager} hide={true} helperText="Press <b>&gt;&gt;</b> when you&#39;re ready to continue, or <b>&#9723;</b> to leave the tutorial." />,
			<Step3 manager={manager} />,
			<Dummy manager={manager} hide={true} helperText="Press <b>&gt;&gt;</b> when you&#39;re ready to continue, or <b>&#9723;</b> to leave the tutorial." />,
			<Step4 manager={manager} />,
			<Dummy manager={manager} hide={true} helperText="You are done with the tutorial. Press <b>&#9723;</b> to start creating your own “Coons patch”!" />,
		];
